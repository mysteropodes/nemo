// Bind the legacy/browser application service to document, history and display ports.
(function (root) {
  'use strict';
  ...
  [['pushUndoLayers', 'undoStack'], ['pushUndoActiveFrame', 'undoStack'],
    ['undo', 'undoStack'], ['redo', 'redoStack']].forEach(function (entry) {

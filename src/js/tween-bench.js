...
(function(){
  ...
  var FLAG_NAMES=['TW_MATCH_RELATIONAL','TW_MATCH_MULTI_MOTION','TW_REL_2OPT','TW_MATCH_TRACKING','TW_PIECE_COMPLETION','TW_MATCH_AXIS','TW_MATCH_TURNING','TW_MATCH_GAP','TW_REL_REVERSE','TW_OC_SIDE_GUARD','TW_ID_PINS','TW_ARC_FROM_CHAIN','TW_TWIN_GROUPS','TW_TEMPORAL_PRIOR',
    'TW_MOTION_FIELD','TW_CHIRALITY','TW_MATCH_WIDTH','TW_MATCH_TOPOLOGY','TW_MATCH_REGIONS','TW_PROVENANCE_PINS','TW_PIN_IN_SOLVER','TW_ORPHAN_FOLLOW','TW_MARGIN_SEEDS','TW_MARGIN_GUARD','TW_ID_BONUS','TW_ID_PINS','TW_DTW_SIGN','TW_GROUP_RIGID','TW_DOUBT_FADE','TW_SPLIT_BACK_RELATIVE','TW_SPLIT_JUNCTION_CUT'];

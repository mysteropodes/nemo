...
function load(frame) {
  ...
  for (const file of ['src/js/animation/curve.js', 'src/js/motion.js', 'src/js/domain/animation/opacity.js']) {
...
test('opacity writes preserve key shape, curves, cloning and holder separation', () => {
  ...
  assert.equal(motion.removeKeyAtCurrentFrame(layer, 'opacity'), null);

...
# Historical remediation handbook manifest

Status: **archived handbook index — 2026-09-07; not an execution entry point**<br>
...
## Historical package contents and current destinations
...
| [01_CURRENT_AND_TARGET.md](../../reference/01_CURRENT_AND_TARGET.md) | Architecture reference; reconcile dated current-state claims with source |
...
| [03_TESTING_AND_DEBUGGING.md](../../reference/03_TESTING_AND_DEBUGGING.md) | Quality reference; Node decision retained, expanded coverage/diagnostics still planned |
| [04_MODULARITY_POLICY.md](../../reference/04_MODULARITY_POLICY.md) | Layer rules, file/function budgets, exceptions and migration method |
| [05_CAPABILITIES_MCP_AND_STANDARDS.md](../../reference/05_CAPABILITIES_MCP_AND_STANDARDS.md) | Capability/application/MCP contracts and future standard ports; new OFX/OCIO/EXR/OTIO breadth deferred |
...
| [templates/TASK_PACKET.md](../../reference/templates/TASK_PACKET.md) | Optional detailed scope reference; use the checklist's issue format for current leaves |
| [templates/HANDOFF_RECEIPT.md](../../reference/templates/HANDOFF_RECEIPT.md) | Optional evidence reference; no additional handoff document required |
...
The historical package used these labels; none establishes present implementation status:
...
## Historical migration note for 0.3.0 — 2026-09-07

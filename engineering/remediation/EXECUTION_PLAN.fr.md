...
- [x] **Le tableau d’abord :** créer [R23 / #1327](https://github.com/mysteropodes/nemo/issues/1327) et la file bornée N00–N05 dans le [Project #2](https://github.com/users/mysteropodes/projects/2) canonique, avec les relations natives de sous-issues et de blocage, tous les champs et un README de projet mis à jour. La relecture du 20 septembre a confirmé R23 et N00 `In progress`, et N01–N05 dans `Inbox` / `Planned later` selon leurs dépendances.
- [ ] **[N00 / #1329](https://github.com/mysteropodes/nemo/issues/1329) :** publier cet amendement anglais/français synchronisé et les règles actives d’entrée dans le dépôt. Aucun travail sur le code source du moteur ne commence avant la revue, la fusion et l’acceptation de N00.
- [ ] **[N01 / #1328](https://github.com/mysteropodes/nemo/issues/1328) :** après N00, rétablir la baseline de la file de remédiation en direct sur le main actuel et cartographier chaque tâche conservée, remplacée ou nouvellement bloquante sans effacer les acceptations ni les responsabilités existantes.
- [ ] **[N02 / #1331](https://github.com/mysteropodes/nemo/issues/1331) :** après N00, figer les contrats du moteur natif, de révision, de commande/requête/job, de transition et d’adaptateur, avec deux exemples concrets de compatibilité/échec et des frontières d’autorité explicites.
- [ ] **[N03 / #1330](https://github.com/mysteropodes/nemo/issues/1330)** et **[N04 / #1332](https://github.com/mysteropodes/nemo/issues/1332) :** après N02, démontrer indépendamment l’évaluation Rust headless et un viewport Tauri natif sur des jeux d’essai représentatifs. Consigner honnêtement les échecs mesurés et les résultats non pris en charge ; une simple compilation ne vaut pas acceptation de faisabilité.
...
4. Après les deux jalons, N05 crée sous R23 les tâches bornées d’implémentation de production ; aucune issue générale de moteur ne constitue une mission d’écriture.

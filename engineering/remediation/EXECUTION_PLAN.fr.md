...
- [ ] **[N05 / #1333](https://github.com/mysteropodes/nemo/issues/1333) :** seulement après les deux jalons de faisabilité, inscrire la file bornée d’implémentation de production avec fichiers, responsables, SHA prédécesseurs, fixtures de parité, matrices de consommateurs, conditions de retrait et commandes de validation locale exacts.
...
N00–N04 disposent de reçus d’acceptation terminaux : fusion N00 `2bd3da7f7e7811b51150bcf95dc669182d2c8f25`, réconciliation des métadonnées/Project N01, fusion N02 `c489e5fbb1822f6a816db3a4d8e901d67382b7a2`, fusion N03 `b37b9cb6a4eb391a248a8dba98cf3f676afbbfe9` et fusion N04 `3084dbf9aeb7010b4ecd24eafee57c106f57c32f`. Les reçus des issues conservent les candidats, contrôles et limites exacts. **N05 reste ouverte jusqu’à l’acceptation de cette file et du plan synchronisé.** N03 est une preuve headless caractérisée qui rejette une opacité modifiée ; N04 est une preuve de viewport macOS. Aucune ne vaut acceptation d’une migration de production.

Le registre des issues après création de N06–N21 contient **171 tâches élémentaires = 142 acceptées + 29 ouvertes (83.04%)**, avant clôture de N05. Après acceptation de N05, et seulement alors, il atteint **143/171 (83.63%)**. Ce sont des résultats d’issues acceptés, préparation et validation comprises ; la première tranche native compte séparément **0/16 acceptations runtime**. Les dossiers du recensement P03 ne constituent pas ce dénominateur ; ni leur nombre ni cette première tranche ne définissent le dénominateur complet de la migration du moteur.

Les seize nouvelles tâches appartiennent à **Ilya (`ivg-design`)**, avec **Ilya/O comme Validation owner**. O utilise `gpt-6-astra/high`, D1 `gpt-5.6-sol/high`, D2 `gpt-5.6-terra/high` ; consigner les réglages effectifs à la prise en charge. L’équipe responsable nomme un relecteur indépendant avant toute écriture. Le nom des nouveaux agents locaux inclut modèle/effort. N06 rencontre un empêchement actif sur des fichiers partagés : Project #2 Status `Needs work`, Board Status `Needs work`, Remediation `Blocked`, Validation `Planned` jusqu’à l’acceptation de N05 et la transmission terminale de #1316/PR #1323. N07–N21 restent en Remediation `Inbox`, Status/Board Status `Planned later`, Validation `Planned` ; avancer uniquement à partir des preuves d’acceptation des prédécesseurs. À chaque prise en charge, consigner leurs SHA de fusion réels, jamais des empreintes prospectives. L’ordre numérique ne définit pas l’état prêt.
...
| [N19 / #1351](https://github.com/mysteropodes/nemo/issues/1351) | Appliquer les frontières natives et la validation locale | R18.3 / O | N13, N15, N16, N17, N18 |
| [N20 / #1352](https://github.com/mysteropodes/nemo/issues/1352) | Basculer atomiquement le sous-ensemble d’opacité admis | R18.1 / O | N17, N18, N19 |
